...
#define RUNTIME_FLAGS(develop,                                              \
  ...
  product(int, HeapDumpGzipLevel, 0, MANAGEABLE,                            \
          ...
          range(0, 9)                                                       \
                                                                            \
  product(ccstr, HeapDumpRedact, nullptr, MANAGEABLE,                          \
          "Redact the heapdump information to remove sensitive data")       \
                                                                            \
  product(ccstr, RedactMap, nullptr, MANAGEABLE,                               \
          "Redact the class and field names to other strings")              \
                                                                            \
  product(ccstr, RedactMapFile, nullptr, MANAGEABLE,                           \
          "File path of the Redact Map")                                    \
                                                                            \
  product(ccstr, RedactClassPath, nullptr, MANAGEABLE,                         \
  ...
  product(bool, VerifyRedactPassword, false,                                \
         "verify authority for operating heapDump redact feature")          \
                                                                            \
  product(ccstr, RedactPassword, nullptr,                                      \
