...
/**
 * Measures the five {@code ArraysSupport} hash code entry points used by String
 * and primitive array hash code callers.
 *
...
public class VectorizedHashCode {
    ...
    @Benchmark
    public int latin1() {
        return ArraysSupport.hashCodeOfUnsigned(latin1, 0, size, 1);
    }

    @Benchmark
    public int utf16() {
        return ArraysSupport.hashCodeOfUTF16(utf16, 0, size, 1);
    }

    @Benchmark
    public int byteArray() {
        return ArraysSupport.hashCode(bytes, 0, size, 1);
    }

    @Benchmark
    public int shortArray() {
        return ArraysSupport.hashCode(shorts, 0, size, 1);
    }

    @Benchmark
    public int intArray() {
        return ArraysSupport.hashCode(ints, 0, size, 1);
    }
