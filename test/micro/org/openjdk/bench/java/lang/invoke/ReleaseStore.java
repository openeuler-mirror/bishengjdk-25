...
public class ReleaseStore {
    ...
    private static final long LONG_ARRAY_BASE = UNSAFE.arrayBaseOffset(long[].class);
    private static final long REFERENCE_ARRAY_BASE = UNSAFE.arrayBaseOffset(Object[].class);
    private static final int INT_ARRAY_SHIFT = Integer.numberOfTrailingZeros(UNSAFE.arrayIndexScale(int[].class));
    private static final int LONG_ARRAY_SHIFT = Integer.numberOfTrailingZeros(UNSAFE.arrayIndexScale(long[].class));
    private static final int REFERENCE_ARRAY_SHIFT = Integer.numberOfTrailingZeros(UNSAFE.arrayIndexScale(Object[].class));
